...
//    public static final Item ACCELERATE_SCROLL = register("accelerate_scroll", new ScrollItem("accelerate", settings().maxCount(1).rarity(Rarity.UNCOMMON)));
    ...
    public static final Item EL_EXPERIENCE_POUCH = register("el_experience_pouch", new ExperiencePouchItem(Archon.CONFIG.elExperiencePouchMax, settings().maxCount(1).rarity(Rarity.EPIC)));
